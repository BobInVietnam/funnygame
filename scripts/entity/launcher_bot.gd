...
func shoot() -> void:
	...
	projectile_instance.direction = Vector2.RIGHT if direction == 1 else Vector2.LEFT
	
	# 6. Add it to the world root so it moves independently of the player
